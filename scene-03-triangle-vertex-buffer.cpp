...
#include "position-color-vertex.h"
#include "renderer.h"
#include <SDL3/SDL.h>
...
void Scene03TriangleVertexBuffer::Load(Renderer &renderer)
{
    ...
    transferData[0] = PositionColorVertex{-.5, -.5, 0, 255, 255, 0, 255};
    transferData[1] = PositionColorVertex{.5, -.5, 0, 255, 0, 255, 255};
    transferData[2] = PositionColorVertex{.5, .5, 0, 0, 255, 255, 255};
    transferData[3] = PositionColorVertex{.5, .5, 0, 0, 255, 255, 255};
    transferData[4] = PositionColorVertex{-.5, .5, 0, 255, 0, 255, 255};
    transferData[5] = PositionColorVertex{-.5, -.5, 0, 255, 255, 0, 255};
    renderer.UnmapTransferBuffer(transferBuffer);
    // Upload the transfer data to the vertex buffer
    SDL_GPUTransferBufferLocation transferBufferLocation = {.transfer_buffer = transferBuffer, .offset = 0};
    SDL_GPUBufferRegion vertexBufferRegion = {
        .buffer = vertexBuffer, .offset = 0, .size = sizeof(PositionColorVertex) * 6};
